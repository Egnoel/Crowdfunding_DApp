...
const Campaignpage = () => {
  ...
  const { data: goal, isLoading: isPendingGoal } = useReadContract({
    contract,
    method: "function goal() view returns (uint256)",
    params: [],
  });
  const { data: deadline, isLoading: isPendingDeadline } = useReadContract({
    contract,
  ...
  return (
    <div className="mx-auto max-w-7xl px-2 mt-4 sm:px-6 lg:px-8 py-2">
      ...
      {!isLoadingBalance && !isPendingGoal && (
        <div className="mb-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          {isEditing && (
            <button
              type="button"
              className="max-w-sm flex flex-col justify-center items-center font-semibold p-6 bg-blue-500 text-white"
